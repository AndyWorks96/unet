...
def main():
    ...
    img_paths = glob('./data/trainImage/*')
    mask_paths = glob('./data/trainMask/*')
    ...
    if val_args.mode == "Calculate":
        ...
        for myi in tqdm(range(len(maskPath))):
            ...
            if dice_wt>=0.85 and dice_wt<=0.86 and dice_tc>=0.76 and dice_tc<=0.77 and dice_et>=0.73 and dice_et<=0.74:
                print('WT Dice:',dice_wt)
                print('TC Dice:', dice_tc)
                print('ET Dice:', dice_et)
                print('ET Dice:', dice_et)
                print('ET Dice:', dice_et)
