...
data_1=np.array([0.85,0.84,0.79,0.87,0.86,0.85,0.99,0.99,0.99])
Chen = np.array([0.91,0.82,0.77,0.93,0.84,0.81,0.99,0.99,0.99])
Sun = np.array([0.88,0.77,0.76,0.88,0.76,0.76,0.99,0.99,0.99])
Cheng = np.array([0.90,0.82,0.76,0.91,0.82,0.77,0.99,0.99,0.99])
...
plt.plot(angles,data_1,'bo-',color='r',linewidth=2, label='Ours',MarkerSize = 5)
plt.fill(angles,data_1,facecolor='r',alpha=0.2)

Chen = np.concatenate((Chen, [Chen[0]]))
plt.plot(angles,Chen,'o-',color='g',linewidth=0.8, label='Reference[29]',MarkerSize = 4)
plt.fill(angles,Chen,facecolor='g',alpha=0.2)

Sun = np.concatenate((Sun, [Sun[0]]))
plt.plot(angles,Sun,'p-',color='k',linewidth=0.8, label='Reference[30]',MarkerSize = 4)
