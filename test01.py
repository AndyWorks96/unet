...
def main():
    val_args = parse_args()
    val_args.name = 'AndyWorks_Unet_5k_woDS'
    ...
    model = unet_5k.__dict__[args.arch](args)
    # # solution: 0
    # device = 'cpu'
    ...
    if val_args.mode == "Calculate":
        ...
        maskPath=glob("/home/banduo/lixing/UNet2D_BraTs/output/AndyWorks_Unet_5k_woDS/"+"GT/*.png")
        # print(maskPath)
        pbPath = glob("./output/AndyWorks_Unet_5k_woDS/" + "*.png")
        # print(pbPath)
        if len(maskPath) == 0:
            print("请先生成图片!")
            return
