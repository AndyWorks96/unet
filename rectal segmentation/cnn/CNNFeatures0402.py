...
class CNNModelTrains(object):
    def __init__(self, model_save='', features_save='', img_size=[24,224,224, 1], n_filters=32, n_features=50):
    ...
    def loadData(self, train_path, label_path):
        ...
        images_3d = np.zeros([43,1, 24, 224, 224], dtype=np.float64)
...
if __name__ == '__main__':
    ...
    cnn_model_train = CNNModelTrains(model_save, features_save, img_size=[32, 448, 448,1], n_features=960, n_filters=16)
