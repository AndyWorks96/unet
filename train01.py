...
import unet_5k
import unet
import UnetNotSymmetry
arch_names = list(unet_5k.__dict__.keys())
...
def parse_args():
    ...
    parser.add_argument('--arch', '-a', metavar='ARCH', default='Unet_5k',
                        choices=arch_names,
...
def main():
    ...
    # Data loading code
    img_paths = glob('./data/testImage1/*')
    mask_paths = glob('./data/testMask1/*')
